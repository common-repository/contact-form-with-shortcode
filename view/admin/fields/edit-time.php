...
<p><?php _e('Field Required Message');?> <input type="text" class="widefat" name="field_titles[]" value="<?php echo $field_title; ?>"  placeholder="<?php _e('Required Message');?>"/></p>
<p><?php _e('Field Placeholder');?> <input type="text" class="widefat" name="field_placeholders[]" value="<?php echo $field_placeholder; ?>" placeholder="<?php _e('Field Placeholder');?>"/></p>
